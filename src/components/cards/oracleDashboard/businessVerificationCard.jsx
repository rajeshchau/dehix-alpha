      ...
      <CardHeader>
        <CardTitle className="flex justify-between">
          ...
          <div className="flex flex-row space-x-3">
            {websiteLink && (
              <a href={websiteLink} target="_blank" rel="noopener noreferrer" className="text-sm underline flex items-center">
                <GlobeIcon className="mt-auto" />
              </a>
            )}
            {linkedInLink && (
              <a href={linkedInLink} target="_blank" rel="noopener noreferrer" className="text-sm underline flex items-center">
                <Linkedin />
              </a>
            )}
            {githubLink && (
              <a href={githubLink} target="_blank" rel="noopener noreferrer" className="text-sm underline flex items-center">
                <Github />
              </a>
            )}
          </div>
        ...
        <CardDescription className="mt-1 text-justify text-gray-600">
          ...
          {verificationStatus === 'pending' ? (
            <Badge className="bg-warning-foreground text-white mt-2">PENDING</Badge>
