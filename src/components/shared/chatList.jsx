...
import { Table, TableBody, TableCell, TableRow } from '../ui/table'; // Importing Table components
import { Card } from '../ui/card'; // Importing Card component

const ChatList = ({ conversations, active, setConversation }) => {
...
// Function to determine badge variant based on label (commented out as in original)
